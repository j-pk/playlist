...
app.get("/favorited/:row", function(req, res) {
    db.collection(FAVORITED_COLLECTION).findOne({
        row: new ObjectID(req.params.id)
    }, function(err, doc) {
        if (err) {
...
app.put("/favorited/:row", function(req, res) {
    ...
    db.collection(FAVORITED_COLLECTION).find({row: req.row}, {favorited: req.body.favorited}, function(err, docs) {
            if (err) {
...
app.delete("/favorited/:id", function(req, res) {
    db.collection(FAVORITED_COLLECTION).deleteOne({
